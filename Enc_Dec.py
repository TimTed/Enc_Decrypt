...
about =     '''
                ...
                {}E-mail            : {} timmytedy7@gmail.com
                {}Github            : {}github.com/TimTed
                {}Telegram          : {}t.me/TimmyTedy
...
def chat():
	...
	os.system('xdg-open https://api.whatsapp.com/send?phone=+2347034457117&text=Assalamualaikum+Roy+Lu+Masih+Jual+Janda?')
kunci = '''
 	{} ▄▀▀▀▄{} *Hello Dude!!
	{} █   █{} *Where Are You?
	███████         ▄▀▀▄
...
def b_menu():
    bm =  '''{}╔═════════════════════════════════════════════╗
║{}[{}+{}]{}Coded    : Timmy Tedy [TT]               ║
║{}[{}+{}]{}Github   : https://github.com/TimTed ║
